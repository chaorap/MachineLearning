...
W1 = np.random.rand(30, 28*28)*np.sqrt(2/(28*28))/1000
B1 = np.random.rand(30, 1)*np.sqrt(2/(28*28))/1000
W2 = np.random.rand(10, 30)*np.sqrt(2/(30))/1000
B2 = np.random.rand(10, 1)*np.sqrt(2/(30))/1000
        ...
        while not IsExit:
            ...
            for j in range(0, inTrainNumber, PreDefine_MiniBatchNumber):
                ...
                if J > OldJ:
                    ...
                    PreDefine_LearnRate = PreDefine_LearnRate*0.99
                    OldJ = OldValidJ
                    W1 = OldW1
                    W2 = OldW2
                    B1 = OldB1
...
def TestMNIST(inTestNumber, IsTrain=True):
    ...
    if True == Load_MNIST_DataSet(inTestNumber,IsTrain=IsTrain):
        ...
        B1 = np.loadtxt("B1.txt", dtype='float', delimiter=",").reshape(30,1)
